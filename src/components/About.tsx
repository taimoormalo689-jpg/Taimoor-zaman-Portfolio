    ...
    <div className="about-section" id="about">
      <div className="about-me">
        ...
        <p className="para">
          ...
          Consistently delivers measurable business impact — including up to 70% reduction in
          manual operations — by bridging cutting-edge AI models with robust enterprise-ready
          backend systems.
        </p>
      </div>
    </div>
